export function NavBar() {
  return (
    <>
      <div className="h-screen bg-gradient-to-b from-[#89483a] to-gray-900">
        <div className="flex h-screen w-full items-center justify-center p-4 align-middle text-slate-200">
          <div className="grid grid-cols-1 grid-rows-2 md:grid-cols-[1fr_auto] md:grid-rows-[1fr]">
            <div className="px-4 py-4 text-center md:py-0 md:text-left">
              ...
              <a href="https://t3.gg/faq">
                <h3 className="text-xl hover:underline">Shop</h3>
              </a>
            </div>
          </div>
          <div className="absolute bottom-0 flex h-16 gap-6 p-4 text-slate-200">
            <a href="https://www.linkedin.com/in/james-yang-chialunyo/" className="flex gap-2 align-baseline">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-6 fill-slate-200">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
              </svg>
              <span className="hidden md:block">LinkedIn</span>
            </a>
            <a href="https://github.com/chia-lun" className="flex gap-2 align-baseline">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="h-6 fill-slate-200">
